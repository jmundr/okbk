...
module.exports.run = async (bot, message, args) => {
  ...
  .setColor("#add8e6")
  .setTitle("BGS BOT Command Menu")
  .setFooter("BGS BOT || Requested By: " + message.author.username, boticon)
